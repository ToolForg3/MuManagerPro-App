    ...
    if (!isPro) {
      ...
      if (isDemoPermitted) {
        ...
        return res.status(403).json({
          ...
          error: (isSqlMutationRoute || isMultiVaultBlocked || isDemoLimitExceeded || isDemoProFieldBlocked) ? 'FUNCION_RESTRINGIDA_PRO' : 'LICENCIA_PRO_REQUERIDA',
          message: reasonMsg,
        });
      }
    }
